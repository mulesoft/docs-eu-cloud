= Configure the Mule Runtime to Connect to the EU Control Plane
ifndef::env-site,env-github[]
include::_attributes.adoc[]
endif::[]

To use Mule Runtime within the EU control plane, you must redefine the configuration properties that enable Mule Runtime to point to the EU control plane. You must also provide the client ID and client secret of the environment belonging to your organization.
