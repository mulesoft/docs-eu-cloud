= Configure Mule runtime engine to Connect to the EU Control Plane
...
The properties you must override depend on the version of Mule runtime engine you are using, as described in the following sections.
